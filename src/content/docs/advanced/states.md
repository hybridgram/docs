...
- **[Middleware](/advanced/middleware/)** — использование middleware для управления состояниями
- **[Отправка сообщений](/sending/telegram-bot-api/)** — отправка ответов пользователям
