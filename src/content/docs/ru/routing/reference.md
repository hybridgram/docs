...
> **Примечание:** Если вы предпочитаете более современный подход, вы можете определять маршруты с помощью атрибутов PHP 8. Смотрите **[Роутинг с PHP атрибутами](/ru/routing/attributes/)** как альтернативный подход к регистрации маршрутов.
