...
Если вы предпочитаете более современный, основанный на атрибутах подход к роутингу, вы можете использовать PHP 8 атрибуты вместо фасада. Это размещает определения маршрутов рядом с методами-обработчиками:
...
**[→ Узнайте о роутинге с PHP атрибутами](/ru/routing/attributes/)**
...
- **[Роутинг с PHP атрибутами](/ru/routing/attributes/)** — современный подход на основе атрибутов
