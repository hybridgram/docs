...
Приоритеты работают только в режиме очередей. Подробнее в разделе [Приоритеты и очереди](/ru/sending/priorities-queues/).
...
- **[Приоритеты и очереди](/ru/sending/priorities-queues/)** — настройка очередей и приоритетов
- **[Rate Limiting](/ru/sending/rate-limiting/)** — управление лимитами запросов
