...
1. **[Установка](/ru/getting-started/installation/)** — установите пакет в свой проект
2. **[Конфигурация](/ru/getting-started/configuration/)** — настройте пакет для работы с вашим ботом
3. **[Роутинг](/ru/basics/routing/)** — создайте первые обработчики
