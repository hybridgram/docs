...
- **[Конфигурация](/ru/getting-started/configuration/)** — детальная настройка пакета
- **[Создание первого роута](/ru/basics/routing/)** — начните создавать обработчики
